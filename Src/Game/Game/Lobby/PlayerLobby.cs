...
using Game.Game.Modes;
using Game.Game.Collection;
...
namespace Game.Lobby
{
    public class Channel
    {
        ...
        public byte[] BuildGameLists()
        {
            ...
            {
                if (Game.GameType == GAME_TYPE.HOLE_REPEAT || Game.GameType == GAME_TYPE.CHIP_IN_PRACTICE || Game.Terminating)
                    continue;
        ...
        public void PlayerCreateGame(GPlayer player, Packet packet)
        {
            ...
            // ✅ Chip-in Practice: ไม่ต้อง override HoleTotal เพราะ client ส่งมาให้แล้ว
            // HoleTotal มาจาก packet.ReadByte() (byte 12) แล้ว ตามที่ผู้เล่นเลือก
            // x2=2, x3=3, x4=4, x5=5, x6=6, x7=7, x8=8, x9=9
            WriteConsole.WriteLine($"[CREATE_GAME] 📊 GameType: {GameData.GameType}, HoleTotal: {GameData.HoleTotal}, PacketSize: {packet.GetSize}", ConsoleColor.Cyan);
        ...
        internal GameBase CreateGame(GPlayer player, GameInformation GameData)
        {
            ...
            switch (GameData.GameType)
            {
                ...
                case GAME_TYPE.CHIP_IN_PRACTICE:
                    {
                        WriteConsole.WriteLine($"[CREATE_GAME] 🎯 Creating CHIP_IN_PRACTICE room for {player.GetNickname}", ConsoleColor.Cyan);
                        ...
                        WriteConsole.WriteLine($"[CREATE_GAME] ✅ CHIP_IN_PRACTICE room created successfully", ConsoleColor.Green);
                    }
                    break;
        ...
        {
            if (GameHandle == null || GameHandle.GameType == GAME_TYPE.HOLE_REPEAT || GameHandle.GameType == GAME_TYPE.CHIP_IN_PRACTICE)
            {
                return;
            }
