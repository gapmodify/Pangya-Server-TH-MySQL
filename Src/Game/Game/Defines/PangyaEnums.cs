namespace Game.Defines
{
    ...
    public enum TGAMEPACKET
    {
        ...
        PLAYER_QUIT_CHIPIN_MODE = 0x0131, // ✅ เพิ่ม packet สำหรับออกจาก Practice/Chip-in
    ...
    public enum TGameShift
    {
        ...
        SHIFT_HOLENUM = 0xB,
        SHIFT_HOLELOCK = 0xC,
        SHIFT_ARTIFACT = 0xD // Artifact setting (ignored - artifacts disabled)
    } // end TGameShift
